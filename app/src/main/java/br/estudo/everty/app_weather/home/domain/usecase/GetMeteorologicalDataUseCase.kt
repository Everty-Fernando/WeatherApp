...
class GetMeteorologicalDataUseCase(
    ...
    suspend operator fun invoke(lat: Double, lon: Double) = getMeteorologicalDataUI(lat, lon)


    private suspend fun getMeteorologicalDataUI(lat: Double, lon: Double): Flow<MeteorologicalDataUI> =
